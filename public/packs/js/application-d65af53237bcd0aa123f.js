...
__webpack_require__(/*! ../timer.js */ "./app/javascript/timer.js");
...
console.log("aaa"); // 時刻表時するtag情報取得

var timeDom = document.getElementById('date'),
    // 取得した現在時刻
date = {
  time: null,
  day: null
...
var setBtn = document.getElementById('setBtn'); // セットボタンクリック時にユーザー情報セット
...
setBtn.onclick = function () {
  ...
  user.age = ageVal;
  user.getup = getupVal;
  user.sleep = sleepVal; // 取得したユーザー情報をローカルストレージに保存
...
setInterval(function () {
  var newDate = new Date(); // 取得した時刻を曜日と時刻表示で分ける

  date.time = "".concat(newDate.getHours(), ":").concat(newDate.getMinutes());
  date.day = newDate.getDay(); // 入力した起床時間と現在時刻が一致したらプッシュ通知
...
/******/ });
//# sourceMappingURL=application-d65af53237bcd0aa123f.js.map